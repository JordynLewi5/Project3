...
public class UpdateProductPriceService {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Starting UpdateProductPrice service at port = " + port);
    ...
    private static void serve(Socket socket, int clientID) throws Exception {
        ...
        PriceIDModel PriceID = new Gson().fromJson(msg, PriceIDModel.class);
        System.out.println(PriceID.price);
        System.out.println(PriceID.productID);

        System.out.println(msg);
        System.out.println("ProductID from client " + clientID + ": " + PriceID.productID);
        Class.forName("org.sqlite.JDBC");
        DataAccess adapter = new SQLiteDataAdapter();
        adapter.connect("jdbc:sqlite:shop.db");

        adapter.updateProductPrice(PriceID.productID, PriceID.price);
